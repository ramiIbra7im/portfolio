...
export default function ProjectsGrid() {
    ...
    const projects = [
        ...
        { id: 12, title: 'El Zaeem', type: t('projects.types.contracting'), tech: ['Next.js', 'Bootstrap'], imageUrl: elzaeem, link: 'https://el-zaeem.com/' },
    ];
            ...
            <div className="container text-center">
                ...
                <motion.div layout className="row g-4 justify-content-center">
                    {currentProjects.map((project, index) => (
                        <motion.div key={project.id} whileHover={{ scale: 1.02 }} className="col-12 col-sm-6 col-lg-4">
                ...
                {totalPages > 1 && (
                    <div className="d-flex justify-content-center align-items-center gap-2 mt-5 flex-wrap">
                        <button className="btn btn-light btn-sm" onClick={() => handlePageChange(currentPage - 1)} disabled={currentPage === 1}>
                            ‹
                        </button>
                        ...
                        <button className="btn btn-light btn-sm" onClick={() => handlePageChange(currentPage + 1)} disabled={currentPage === totalPages}>
                            ›
                        </button>
                    </div>
                )}
