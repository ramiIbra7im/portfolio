  ...
  return (
    <div className="container-fluid price-co pb-4 ">
      ...
      <div className="container row pricing gap-4 text-center m-auto  m-0 p-0">
        <div className=" price1 shadow col-lg mb-4 p-4 " data-aos="fade-up" data-aos-delay="0">
          <div className="text-white">

            <h3>Basic</h3>
            <h2 className=" fw-bold mt-2">600 - 1000 EGP</h2>
          </div>
        ...
        <div className=" price2 shadow col-lg p-3 mb-4 p-4" data-aos="fade-down" data-aos-delay="150">
          <div className="text-white">

            <h3>Standard</h3>
            <h2 className=" fw-bold mt-2">1200 - 1800 EGP</h2>
          </div>
        ...
        <div className=" price3 shadow col-lg p-4 mb-4" data-aos="fade-up" data-aos-delay="300">
          <div className="text-white">

            <h3>Pro</h3>
            <h2 className=" fw-bold mt-2">3000 - 4000 EGP</h2>
          </div>
      ...
      <div className="container gift-co p-2 d-flex gap-3 align-items-center">
        <div className="fs-1 icon-gift mb-2">
          <FaGift />
        </div>
        <p className="mb-0  fw-bold">Prices are approximate and may vary depending on your project details. If you have any concerns about the pricing, feel free to reach out —I’
          ll do my best to find a solution that fits your needs. All packages are based on React development</p>
      </div>
      <div className="container warning-co p-2 d-flex gap-3 align-items-center mt-4">
        <div className="fs-1 icon-warning pb-3 ">
          <AiOutlineWarning />
        </div>
        <p className="mb-0  fw-bold">All the mentioned packages cover front-end development using React. If your project requires back-end development or a database –
          such as login systems, dashboards, or data storage – we will collaborate with a specialized back-end developer. The cost for back-end development will be
          calculated separately based on your specific project requirements.</p>
      </div>
    </div>
  );
}
